...
pub struct Kernels {
    ...
    pub lion_step: CudaFunction,
    pub cross_entropy_fwd_bwd: CudaFunction,
    pub kd_apply: CudaFunction,
    pub focal_apply: CudaFunction,
    pub label_smooth_apply: CudaFunction,
...
impl PtxContext {
    pub fn new() -> Result<Self, Box<dyn Error>> {
        ...
        let k = Kernels {
            ...
            lion_step: module.load_function("lion_step")?,
            cross_entropy_fwd_bwd: module.load_function("cross_entropy_fwd_bwd")?,
            kd_apply: module.load_function("kd_apply")?,
            focal_apply: module.load_function("focal_apply")?,
            label_smooth_apply: module.load_function("label_smooth_apply")?,
