...
| 12 | [`experiments/12_raw_trace_stack/`](experiments/12_raw_trace_stack/) | active | Trace-derived stack state without hand-given depth |
| 13 | [`experiments/13_multi_surface_stack/`](experiments/13_multi_surface_stack/) | active | Stack operator transfer across surface languages |
| 14 | [`experiments/14_operator_guided_decoding/`](experiments/14_operator_guided_decoding/) | active | Learned operator inside the decoding loop |
| 15 | [`experiments/15_comparator_transfer/`](experiments/15_comparator_transfer/) | active | Compare/swap operator transfer |
| 16 | [`experiments/16_trace_to_operator_search/`](experiments/16_trace_to_operator_search/) | active | Search over state encodings for verified operators |
| 17 | [`experiments/17_operator_registry/`](experiments/17_operator_registry/) | active | Registry contract for reusable operators |
| 18 | [`experiments/18_operator_composition/`](experiments/18_operator_composition/) | active | Composition of parser/stack harness and comparator |
| 19 | [`experiments/19_language_to_role_trace/`](experiments/19_language_to_role_trace/) | active | Language as adapter into role traces |
| 20 | [`experiments/20_runtime_learning_episode/`](experiments/20_runtime_learning_episode/) | active | Runtime learning of a new transition rule |
| 21 | [`experiments/21_lab_organ_demo/`](experiments/21_lab_organ_demo/) | active | Minimal language-to-role/operator/registry loop |
